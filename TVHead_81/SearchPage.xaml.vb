...
Public NotInheritable Class SearchPage
    Inherits Page
    ...
    Private Sub NavigationHelper_LoadState(sender As Object, e As LoadStateEventArgs) Handles _navigationHelper.LoadState
        ...
        DefaultViewModel("SearchViewModel") = DirectCast(e.NavigationParameter, SearchPageViewModel)
...
#Region "NavigationHelper registration"
    ...
    Protected Overrides Sub OnNavigatedFrom(e As NavigationEventArgs)
        ...
        Dim vm As SearchPageViewModel = DefaultViewModel("SearchViewModel")
        If Not vm.GroupedSearchResults Is Nothing Then vm.GroupedSearchResults.Clear()
        vm.SearchValue = ""
